...
main: main.o student.o file_functions.o database_functions.o qlang.o
	g++ -std=c++11 -pedantic-errors main.o student.o file_functions.o database_functions.o qlang.o -o main
